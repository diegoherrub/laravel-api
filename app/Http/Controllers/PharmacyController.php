...
use App\Http\Resources\PharmaciesOnCallResource;
...
//    public function getPharmaciesOnCall(): \Illuminate\Http\JsonResponse
//    {
//        try {
...
//                }
//            }
//            return response()->json(PharmaciesOnCallResource::collection($nextPharmacies), 200);
//        } catch (\Exception $e) {
